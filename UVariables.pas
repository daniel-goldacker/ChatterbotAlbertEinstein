...
uses sysutils,ULogging;
  ...
  Procedure TMemory.Save;
    ...
    begin
      ...
      Log.Log('Variáveis','Salvando variáveis para o bor em: ' + bot_id + '.variables');
      try
        Vars.SaveToFile(filename);
      except
        Log.Log('Variáveis','Erro ao salvar váriaveis');
      end;
    end;
  Procedure TMemory.Load;
    ...
    begin
      ...
      if fileexists(filename) then begin
        Log.Log('Variáveis','Carregando variáveis para o bot no arquivo: ' + bot_id);
